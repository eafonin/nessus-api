...
<CodeGroup>
  ```python Dict Return (No Schema Needed) theme={"theme":{"light":"snazzy-light","dark":"dark-plus"}}
  @mcp.tool
  ...
  ```json Traditional Content theme={"theme":{"light":"snazzy-light","dark":"dark-plus"}}
  "{\n  \"name\": \"Alice\",\n  \"age\": 30,\n  \"active\": true\n}"
  ```

  ```json Structured Content (Automatic) theme={"theme":{"light":"snazzy-light","dark":"dark-plus"}}
  {
    "name": "Alice", 
    "age": 30,
    "active": true
...
<CodeGroup>
  ```python Integer Return (No Schema) theme={"theme":{"light":"snazzy-light","dark":"dark-plus"}}
  @mcp.tool  
  ...
  ```json Traditional Content Only theme={"theme":{"light":"snazzy-light","dark":"dark-plus"}}
  "8"
  ```

  ```python Integer Return (With Schema) theme={"theme":{"light":"snazzy-light","dark":"dark-plus"}}
  @mcp.tool
  ...
  ```json Structured Content (From Schema) theme={"theme":{"light":"snazzy-light","dark":"dark-plus"}}
  {
    "result": 8
  }
  ```
